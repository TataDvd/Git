        ...
        public class VirtualizingCollection<T> : IList<T>, IList
        {
            ...
            public T this[int index]
            {
                get
                {
                    ...
                    if (_pages.ContainsKey(pageIndex) &&_pages[pageIndex] == null)
                        return default(T);

                    // return requested item
                    if (_pages.ContainsKey(pageIndex) && _pages[pageIndex].Count()>pageOffset) return _pages[pageIndex][pageOffset];
                    return default(T);
                }
            ...
            object IList.this[int index]
            {
                ...
                {
                    var itm = this[index];
                    return itm == null ? new object() : itm;
