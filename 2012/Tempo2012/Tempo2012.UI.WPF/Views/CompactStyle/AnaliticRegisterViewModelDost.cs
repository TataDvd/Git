...
{
    internal class AnaliticRegisterViewModelDost : BaseViewModel, IReportBuilder
    {
        public Dictionary<int, List<string>> Rowfoother { get; set; }
        public AnaliticRegisterViewModelDost()
        {
        ...
        public List<List<string>> GetItems()
        {
            ...
            List<Conto> contos0 = new List<Conto>(Context.GetAllContoWithDdsAndNot(ConfigTempoSinglenton.GetInstance().CurrentFirma.Id, Entrence.Mask,ItemsDebit[0].Value,"12"));
            ...
            List<Conto> contos = new List<Conto>(Context.GetContosByContragent(ConfigTempoSinglenton.GetInstance().CurrentFirma.Id, Entrence.Mask.FromDate, Entrence.Mask.ToDate, di[0].Value, "12"));
        ...
        public List<string> GetFuther()
        {
            ...
            list.Add(string.Format("| Начални салдo  по сметка    |{0,20}|{1,20}|", CurrenAcc.TypeAccount == 1 ? (BeginSaldoD-BeginSaldoK).ToString() : "", CurrenAcc.TypeAccount == 2 ? (BeginSaldoK-BeginSaldoD).ToString() : ""));
