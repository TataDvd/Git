...
{
    internal class AnaliticRegisterViewModelTrueContr : BaseViewModel, IReportBuilder
    {
        public Dictionary<int, List<string>> Rowfoother { get; set; }
        public AnaliticRegisterViewModelTrueContr()
        {
        ...
        public List<List<string>> GetItems()
        {
            ...
            List<Conto> contos0 = new List<Conto>(Context.GetAllContoWithDdsAndNot(ConfigTempoSinglenton.GetInstance().CurrentFirma.Id, Entrence.Mask,ItemsDebit[0].Value,"11"));
            ...
            List<Conto> contos = new List<Conto>(Context.GetContosByContragent(ConfigTempoSinglenton.GetInstance().CurrentFirma.Id, Entrence.Mask.FromDate, Entrence.Mask.ToDate, di[0].Value, "11"));
