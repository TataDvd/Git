    ...
    public class DeklarviewModel
    {
        ...
        public static string ReturnViesDeclar(Dictionary<string, string> declar, List<ViesRow> list)
        {
          ...
          sb.AppendFormat("| Общ брой редове в декларацията                                  |{0,22}| 02|",declar["count"]);sb.AppendLine();
            ...
            sb.AppendLine("|под режим складиране на стоки до поискване по чл. 15а, ал. 1 от ЗДДС, настъпила по чл. 15а, |");
            sb.AppendLine("|ал. 4 и 5 от ЗДДС или корекция на грешно посочен идентификационен промяна членка под режим  |");
            sb.AppendLine("|складиране на стоки до поискване по чл. 15а, ал. 1 от ЗДДС, настъпила декларация.           |");
            sb.AppendLine("+--------------------------------------------------------------------------------------------+");
            sb.AppendLine("|Общ брой редове в раздел \"Г\" на декларацията                                              |");
            sb.AppendLine("+------+------------------+------------------- +--------------------+------------------------+");
