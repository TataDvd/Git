        ...
        public static string ReturnViesDeclar(Dictionary<string, string> declar, List<ViesRow> list, List<ViesRowG> listg)
        {
          ...
          sb.AppendFormat("| Общ брой редове в раздел \"В\" на декларацията                  |{0,22}| 02|", declar["count"]);sb.AppendLine();
            ...
            if (listg.Count > 0)
            {
                ...
                sb.AppendLine("+--------------------------------------------------------------------------------------------+");
                sb.AppendFormat("| Общ брой редове в раздел \"Г\" на Декларацията                  |{0,22}| 02|", declar["countG"]); sb.AppendLine();
                sb.AppendLine("+------+------------------+------------------- +--------------------+------------------------+");
                ...
                sb.AppendLine("|ред   |придобиващия      |по режим складиране | доставки  на       |     извършена          |");
                sb.AppendLine("|      | (вкл.знака)      |стоки до поискване* |  стоки като        |    операцията по       |");
                sb.AppendLine("|      |                  |                    |  посредник в       |   режим складиране     |");
                ...
                {
                    sb.AppendFormat("|{0,6}|{1,-18}|{2,20}|{3,20}|{4,24}|", l.NomRow, l.VIN, l.KOD, l.VINDest, l.PeriodOP);
                    sb.AppendLine();
                }
                sb.AppendLine("+------+------------------+--------------------+--------------------+------------------------+");
            }
