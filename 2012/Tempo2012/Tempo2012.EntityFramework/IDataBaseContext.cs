...
namespace Tempo2012.EntityFramework
{
    public interface IDataBaseContext
    {
        ...
        IEnumerable<IEnumerable<string>> GetDetailsContoToAccUni(int id, int typeAccount,int kol,int val,string filter,int first,int ofset);
        int GetDetailsContoToAccUniCount(int id, int typeAccount, string filter);
