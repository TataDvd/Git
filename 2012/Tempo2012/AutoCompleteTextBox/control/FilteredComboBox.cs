...
namespace dragonz.actb.control
{
    ...
    {        
        public static readonly DependencyProperty MinimumSearchLengthProperty = DependencyProperty.Register( "MinimumSearchLength",typeof(int),typeof(FilteredComboBox),new UIPropertyMetadata(3));
        ...
        /// </summary>        /// <param name="e">A KeyBoardFocusChangedEventArgs.</param>
